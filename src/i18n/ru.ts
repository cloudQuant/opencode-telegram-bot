...
export const ru: I18nDictionary = {
  ...
  "cmd.description.loop": "Запустить режим автоповтора",
  "cmd.description.stop_loop": "Остановить автоповтор",
  "cmd.description.loop_status": "Статус автоповтора",

  "loop.usage":
    "🔄 Использование:\n/loop <промпт> - запуск цикла с промптом (макс. 100 итераций)\n/loop:50 <промпт> - запуск цикла (макс. 50 итерациs)\n/stop_loop - остановить текущий цикл\n/loop_status - показать статус цикла\n\nПример:\n/loop Проанализируй качество кода и предложи улучшения",
  "loop.already_active": "⚠️ Цикл уже активен. Сначала остановите его через /stop_loop.",
  "loop.not_active": "⚠️ Нет активного цикла. Используйте /loop <промпт> для запуска.",
};
